 ...
 *
 * Do NOT add edge caching here (unlike worker/tmdb-proxy.js): the AID token is
 * short-lived and live/offline state flips constantly. A cached response hands
 * the TV a dead stream.
 *
